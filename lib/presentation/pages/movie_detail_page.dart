                              ...
                              builder: (context, state) {
                                if (state is MovieWatchlistStatusLoading) {
                                  return Center(
                                    ...
                                    is MovieWatchlistStatusIsAdded) {
                                  ...
                                  return ElevatedButton(
                                    onPressed: () async {
                                      if (!isAddedWatchlist) {
                                        context
                                            .read<MovieWatchlistStatusBloc>()
                                            .add(OnAddMovieWatchlistStatus(
                                                movie));
                                      } else {
                                        context
                                            .read<MovieWatchlistStatusBloc>()
                                            .add(
                                                OnRemoveWatchlistStatus(movie));
                                      }
                                    },
                                    child: Row(
                            ...
                            BlocBuilder<MovieRecommendationsBloc,
                              ...
                              builder: (context, state) {
                                if (state is MovieRecommendationsLoading) {
                                  ...
                                  return Text(state.message);
                                } else if (state is MovieRecommendationsData) {
                                  return Container(
                                    height: 150,
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        final movie =
                                            state.resultRecommendations[index];
                                        return Padding(
                                      ...
                                      itemCount:
                                          state.resultRecommendations.length,
                                    ),
                                  );
                                } else {
                                  return Container();
